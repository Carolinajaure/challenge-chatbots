...
// Create the 'Entradas' collection if it doesn't exist
...
// Create the 'Gohan' collection if it doesn't exist
...
// Create the 'Rolls' collection if it doesn't exist
...
// Create the 'Combos' collection if it doesn't exist
